  ...
  <div className="max-w-lg mx-auto">
    ...
    <form action="">
      ...
      <div className="flex flex-wrap -mx-4 mb-6 items-center justify-between">
        ...
        <Link to="/forgotpassword"><div className="w-full lg:w-auto px-4"><a className="inline-block font-extrabold hover:underline" href="#">Forgot your
            password?</a></div></Link>
      </div>
      <button className="inline-block w-full py-4 px-6 mb-6 text-center text-lg leading-6 text-white font-extrabold bg-indigo-800 hover:bg-indigo-900 border-3 border-indigo-900 shadow rounded transition duration-200">Login</button>
      <p className="text-center font-extrabold">Don&rsquo;t have an account? <Link className="text-red-500 hover:underline" to="/signup">Sign up</Link>
      </p>
    </form>
  </div>
</div>
